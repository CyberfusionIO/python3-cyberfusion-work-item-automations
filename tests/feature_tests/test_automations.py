...
def test_create_issue_assignee_group_selection(
    ...
    ID_PROJECT = 182
    ID_GROUP_ASSIGNEE = 286

    path = get_tmp_file()

    example_assignee_group_name = "example-assignee-group"
            ...
            "create_issue": [
                {
                    ...
                    "schedule": "5 13 3 * *",
                    "assignee_group": example_assignee_group_name,
                },
            ]
        },
    }
    ...
    requests_mock.get(
        config.url + "/api/v4/groups/" + example_assignee_group_name,
        status_code=200,
        json={
            "id": ID_GROUP_ASSIGNEE,
            "web_url": "https://gitlab.example.com/groups/"
            + example_assignee_group_name,
            "name": "Example Assignee Group",
            "path": example_assignee_group_name,
            ...
            "full_path": example_assignee_group_name,
    ...
    members = [
        {
            ...
            "web_url": "https://gitlab.example.com/owner",
            "access_level": 50,
        ...
        },
        {
            ...
            "state": "active",
            "locked": False,
            "avatar_url": "https://gitlab.example.com/uploads/-/system/user/avatar/3/avatar.png",
        ...
        },
        {
            ...
            "state": "active",
            "locked": False,
            "avatar_url": "https://gitlab.example.com/uploads/-/system/user/avatar/4/avatar.png",
            "web_url": "https://gitlab.example.com/reporter",
            "access_level": 20,
            "created_at": "2025-01-15T11:54:58.083+01:00",
            "expires_at": None,
        ...
        },
        {
            ...
            "web_url": "https://gitlab.example.com/guest",
            "access_level": 10,
            "created_at": "2025-01-15T11:54:58.083+01:00",
            "expires_at": None,
        ...
        },
        {
            ...
            "state": "active",
            "locked": False,
            "avatar_url": "https://gitlab.example.com/uploads/-/system/user/avatar/6/avatar.png",
            "web_url": "https://gitlab.example.com/minimal-access",
            "access_level": 5,
            "created_at": "2025-01-15T11:54:58.083+01:00",
            "expires_at": None,
    ...
    requests_mock.get(
        config.url + "/api/v4/groups/" + str(ID_GROUP_ASSIGNEE) + "/members",
        status_code=200,
        json=members,
        headers={
            "content-type": "application/json",
